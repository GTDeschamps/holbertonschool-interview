 ...
 * @n: A pointer to an integer where the function will store
 * the number of results.
 *
 * Return: An allocated array containing each index in `s`
 * 			where a valid substring starts.
